...
while is_converged == 0
    ...
    Z4_next = Z4 + params.gamma2(4)*(Hr_bar + Shr_bar); % line 24
    Z5_next = Z5 + params.gamma2(5)*(SB(Hr_bar) + Slr_bar); % line 25
    Z6_next = Z6 + params.gamma2(6)*(SB(Ht_bar) + Slt_bar); % line 26
