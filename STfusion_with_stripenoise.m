...
while is_converged == 0
    ...
    preThr_next = preThr - params.gamma1(3) * (Z4 + Dvt(Z7)); 
    preThr_next = projFastL1Ball(preThr_next, params.thetah); % line 13
    preTlr_next = preTlr - params.gamma1(4) * (Z5 + Dvt(Z8)); 
    preTlr_next = projFastL1Ball(preTlr_next, params.thetal); % line 14
    preTlt_next = preTlt - params.gamma1(5) * (Z6 + Dvt(Z9)); 
    ...
    Z4_next = Z4 + params.gamma2(4)*(Hr_bar + Thr_bar); % line 24
    Z5_next = Z5 + params.gamma2(5)*(SB(Hr_bar) + Tlr_bar); % line 25
    Z6_next = Z6 + params.gamma2(6)*(SB(Ht_bar) + Tlt_bar); % line 26
